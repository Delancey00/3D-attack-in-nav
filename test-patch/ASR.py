...
def calculate_attack_success_rate(cfg: DictConfig) -> None:
    ...
    for idx, camera_position in enumerate(camera_positions):
        ...
        logger.info(f"Processed image {idx + 1}/{total_configs}, Attack Successes?: {target_class_idx not in detected_classes}, ASR: {attack_successes/(idx + 1):.2f}")
...
@hydra.main(version_base=None, config_path="/home/wmy/project/Physical-Attacks-in-Embodied-Nav/configs", config_name="config")
