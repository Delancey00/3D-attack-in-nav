...
if __name__ == "__main__":
    ...
    dt2_cfg = get_cfg()
    dt2_cfg.merge_from_file("pretrained-models/mask_rcnn_R_101_cat9/config.yaml")
    dt2_cfg.MODEL.WEIGHTS = "pretrained-models/mask_rcnn_R_101_cat9/mask_rcnn_R_101_cat9.pth"
